// CS265_Lab1.java provided by lecturer to test.
...
public class CS265_Lab1 {
	 ...
	 * does not matter. 
	 * 
	 * @param j - a String array
	 * @param k - a string
	 * @return boolean indicating if the needle is found in the haystack
	 * 
	 */
	
	public static boolean method2(String[] arr, String needle)
	{
		boolean found = false;
		...
		else
		{
			...
			while ((i < arr.length) && (!found))
			{
				if (arr[i] != null)
				{
					if (arr[i].compareToIgnoreCase(needle) == 0)
					{	
						found = true;
					}
				}
